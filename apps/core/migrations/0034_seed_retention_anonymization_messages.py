# US-013: seed retention portal + republish + anonymization domain messages.
...
def forward(apps, schema_editor):
    ...
    seed_from_translation_data_directory(
        directory=root,
        apps=apps,
        only_json_filenames=("other_api.json", "other_domain.json"),
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0033_seed_other_api_request_body_errors"),
    ]
