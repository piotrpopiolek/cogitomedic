# Seed other.domain.* messages and new other.api.* keys (publish_request_id_*).
...
def forward(apps, schema_editor):
    ...
    seed_from_translation_data_directory(
        directory=root,
        apps=apps,
        only_json_filenames=("other_domain.json", "other_api.json"),
    )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0031_seed_administration_errors"),
    ]
