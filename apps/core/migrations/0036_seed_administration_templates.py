# Seed administration.* translation keys for admin template strings.
# Replaces hardcoded Polish/German strings in admin templates.
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("core", "0035_seed_administration_app_labels"),
    ]
