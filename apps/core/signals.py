...
from apps.core.translation_service import ALLOWED_LANGUAGE_CODES, bump_translation_version


@receiver(post_save, sender=TranslationValue)
def _bump_translation_value_version_on_save(sender, instance: TranslationValue, **kwargs):
...
def _bump_translation_value_version_on_delete(sender, instance: TranslationValue, **kwargs):
    bump_translation_version(instance.translation_key.category, instance.language_code)
