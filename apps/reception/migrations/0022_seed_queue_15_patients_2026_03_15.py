# Seed queue for 15 March 2026 with 15 patients. Reuses patient set from 0012/0017/0021.
# Forward: get_or_create queue for 2026-03-15; ensure 15 queue entries.
...
def seed_queue_15_patients_2026_03_15(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("reception", "0021_seed_queue_15_patients_2026_03_14"),
        ("users", "0001_initial"),
    ]

    operations = [
        migrations.RunPython(seed_queue_15_patients_2026_03_15, noop_reverse),
    ]
