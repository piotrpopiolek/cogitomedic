# Seed queue for 14 March 2026 with 15 patients. Reuses patient set from 0012/0017.
# Forward: get_or_create queue for 2026-03-14; ensure 15 queue entries.
...
def seed_queue_15_patients_2026_03_14(apps, schema_editor):
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("reception", "0020_patient_phone_unique_normalized"),
        ("users", "0001_initial"),
    ]

    operations = [
        migrations.RunPython(seed_queue_15_patients_2026_03_14, noop_reverse),
    ]
